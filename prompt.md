...
**CRITICAL**: If a section labeled `[CUSTOM_PROJECT_INSTRUCTIONS]` appears above, those instructions take **ABSOLUTE PRECEDENCE** over all other rules in this prompt.
